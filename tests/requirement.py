...
class MyTestCase(unittest.TestCase):
    ...
    def test_complex_expr(self):
        requirements = (
            Requirement(rq_group="123", key="1", line_type="RQ", rqs_typ="PRE", operator="EQ", conn="OR", rqrmnt="789"),
            Requirement(rq_group="123", key="2", line_type="CRSE", rqs_typ="PRE", operator="EQ", parenth="(", course_id="123456"),
